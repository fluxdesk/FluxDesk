...
import { ArrowLeft, CheckCircle2, ChevronRight, Database, HardDrive, Loader2, PlayCircle, XCircle } from 'lucide-react';
...
export default function DatabaseSetup({ appName, currentDriver }: Props) {
    ...
    const handleDriverChange = (driver: string) => {
        ...
        // Reset connection test when driver changes
    ...
    const handleInputChange = (field: string, value: string) => {
        ...
        // Reset connection test when any field changes
        if (connectionTested) {
            setConnectionTested(false);
            setConnectionSuccess(false);
            setTestMessage('');
    ...
    // SQLite doesn't need a connection test
